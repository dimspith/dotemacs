...
The font used.
#+BEGIN_SRC emacs-lisp
  (add-to-list 'default-frame-alist '(font . "Monego 11" ))
  (set-face-attribute 'default nil :family "Monego 12" :height 110 :weight 'normal)
...
(use-package org
  ...
  (setq org-agenda-files '("~/.emacs.d/notes/notes.org"))
  :bind
  ("C-c o a" . org-agenda)
